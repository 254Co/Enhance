...
def linear_svc_process(input_df: DataFrame, label_col: str, feature_cols: list):
    """
    Trains a linear SVC model on the input DataFrame.
    ...
    try:
        ...
        logger.info("Creating LinearSVC model")
        lsvc = LinearSVC(labelCol="indexedLabel", featuresCol="features")

        logger.info("Creating pipeline with indexer, assembler, and LinearSVC")
